...
//    
    ...
    particleUniforms[currentPointIndex].gridPoint = gridPoint;
    particleUniforms[currentPointIndex].currentPointIndex = currentPointIndex;
    particleUniforms[currentPointIndex].texCoord = texCoord;
    
}
//current vertex index가 vertex_id인데,,
...
//stage_in parameter로 pointer를 각각 지정할 필요가 없어짐
...
//    PointCloudUniforms.position = projectedPosition
//    PointCloudUniforms.color = sampledColor
